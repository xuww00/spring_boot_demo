...
//        String base64 = encode.encode(sb.toString().getBytes("UTF-8"));
        String base64= encode.encodeBuffer(sb.toString().getBytes("UTF-8"));
    ...
    public static byte[] hexStr2ByteArr(String strIn) throws Exception {
        ...
        int[] arrOut1 = new int[iLen / 2];
        for (int i = 0; i < iLen; i = i + 2) {
            String strTmp = new String(arrB, i, 2);
            arrOut[i / 2] = (byte) Integer.parseInt(strTmp, 16);
            arrOut1[i / 2]=Integer.parseInt(strTmp, 16);
        }
    ...
    public static String decrypt(String strIn,String key) throws Exception {
        ...
        byte[] p = decoder.decodeBuffer(strIn);
        strIn= new String(p);
