...
public class pingyin {
     ...
     */
    public static int getCnAscii(char cn)throws Exception {
     ...
     * 转换成全拼后的字符串 
     */
    public static String getFullSpell(String cnStr)throws Exception {
     ...
     * @return 返回转换后的拼
     */
    public static String getFirstSpell(String cnStr)throws Exception {
        if (null == cnStr || "".equals(cnStr.trim())) {
            return cnStr;
        }
    ...
    public static void main(String[] args)throws Exception {
        ...
        // 转换成拼音  
        System.out.println(pingyin.getFullSpell(str));
    }
}  
